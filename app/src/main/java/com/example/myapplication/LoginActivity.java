...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBinding.loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String id = mBinding.IDEditText.toString();
                String pw = mBinding.passwordEditText.toString();
                hideKeyboard();
    ...
    public void LoginResponse() {
        String userID = mBinding.IDEditText.getText().toString().trim();
        String userPassword = mBinding.passwordEditText.getText().toString().trim();
    ...
    private void hideKeyboard()
    {
        ...
        imm.hideSoftInputFromWindow(mBinding.IDEditText.getWindowToken(), 0);
